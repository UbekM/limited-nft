...
export interface LimitedNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "approve"
...
export interface LimitedNFT extends BaseContract {
  connect(runner?: ContractRunner | null): LimitedNFT;
  waitForDeployment(): Promise<this>;

  interface: LimitedNFTInterface;
