          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left space-y-8 animate-fade-in">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="gradient-text">Limited NFT</span> Collection
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <Link to="/gallery?mint=true" className="btn-secondary">
                  Mint Now
                </Link>
              </div>
            ...
            <div className="hidden lg:block relative h-[600px]">
              {[1, 2, 3].map((id, index) => (
                <div
                  key={id}
                  className="absolute w-48 h-48 rounded-xl border border-white/10 overflow-hidden animate-float"
                  style={{
                    top: `${index * 40}%`,
                    right: `${index * 10}%`,
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="card group">
                <div
                  className={`w-16 h-16 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center text-3xl mb-6`}
                >
                  {feature.icon}
                </div>
            ...
            {[
              ...
              <div key={index} className="relative">
                <div className="card h-full">
                  ...
                  <div className="aspect-video bg-gradient-to-br from-primary/20 to-primary-hover/20 rounded-xl mb-6 flex items-center justify-center text-text-primary font-semibold">
                    {step.image}
                  </div>
      ...
      <section className="py-20 md:py-32 bg-dark-surface">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <Link to="/gallery?mint=true" className="btn-primary inline-block">
              Start Minting
            </Link>
          </div>
        </div>
